...
const mockArticles = [
  ...
  },
  {
    ...
    status: 'daily',
    isFavorite: false,
  tags: ['tag-2', 'tag-26', 'tag-27', 'tag-1'],
  ...
  },
  {
    ...
    status: 'daily',
    isFavorite: true,
  tags: ['tag-28', 'tag-29', 'tag-7', 'tag-30'],
  ...
  },
  {
    ...
    status: 'rediscovery',
    isFavorite: true,
  tags: ['tag-35', 'tag-36', 'tag-9', 'tag-37'],
  ...
  },
  {
    ...
    status: 'rediscovery',
    isFavorite: false,
  tags: ['tag-38', 'tag-39', 'tag-40', 'tag-41'],
  ...
  },
  {
    ...
    status: 'continue',
    isFavorite: true,
  tags: ['tag-6', 'tag-25', 'tag-7', 'tag-24'],
    dateAdded: new Date('2024-01-15'),
    hasAnnotations: true,
    readProgress: 50,
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
  ...
  },
  {
    ...
    status: 'archived',
    isFavorite: false,
  tags: ['tag-3', 'tag-47', 'tag-18', 'tag-8'],
  ...
  },
  {
    ...
    status: 'archived',
    isFavorite: true,
  tags: ['tag-1', 'tag-26', 'tag-27', 'tag-19'],
