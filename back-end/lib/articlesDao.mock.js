...
const ARTICLES_DATA_FILE = path.join(__dirname, '../data/mockArticles.js');
...
/**
 * Persist current articles to the data file
 */
const persistArticles = () => {
  try {
    const content = `/**\n * Auto-generated by articlesDao - DO NOT EDIT MANUALLY\n * Changes made through API will be persisted here\n */\n\nconst mockArticles = ${JSON.stringify(articles, null, 2)};\n\nmodule.exports = { mockArticles };\n`;
    fs.writeFileSync(ARTICLES_DATA_FILE, content, 'utf8');
  } catch (error) {
    console.error('Failed to persist articles to file:', error);
  }
};
